...
$DATABASE_OBJECTS = array(
    new FeatureInfo("Feature 1","1.A pseudo-Latin text used in web design, layout, and printing in place of English to emphasise design elements."),
    new FeatureInfo("Feature 2","2.A pseudo-Latin text used in web design, layout, and printing in place of English to emphasise design elements."),
    new FeatureInfo("Feature 3","3.A pseudo-Latin text used in web design, layout, and printing in place of English to emphasise design elements."),
    new FeatureInfo("Feature 4","4.A pseudo-Latin text used in web design, layout, and printing in place of English to emphasise design elements.")
);
...
class PriceInfo{
     ...
     * @param $link
     */
    public function __construct($priceType, $price, $offers, $link)
    {
...
$PRICES = array(
    new PriceInfo("Starter",27, array("Lorem ipsum is common text","Lorem ipsum is common text","Lorem ipsum is common text","Lorem ipsum is common text"),"#demo1"),
    new PriceInfo("Professional",97, array("Lorem ipsum is common text","Lorem ipsum is common text","Lorem ipsum is common text","Lorem ipsum is common text"),"#demo2"),
    new PriceInfo("Business",147, array("Lorem ipsum is common text","Lorem ipsum is common text","Lorem ipsum is common text","Lorem ipsum is common text"),"#demo3")
);
?>
<head>
    <meta charset="utf-8">
                ...
                <div class="container">
                    <div class="features-inner section-inner">
                        <div class="features-wrap">
                            <?php for($i = 0; $i < sizeof($DATABASE_OBJECTS); $i++):?>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile"><?php echo $DATABASE_OBJECTS[$i] -> getFeatureName();?></h4>
                                    <p class="text-sm"><?php echo $DATABASE_OBJECTS[$i] -> getDescription();?></p>
                                </div>
                            </div>
                            <?php endfor; ?>
                        </div>
                                ...
                                <div class="pricing-table-inner">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            <div class="pricing-table-title mt-12 mb-8"><?php echo $PRICE -> getPriceType()?></div>
                                            <div class="pricing-table-price mb-32 pb-24"><span class="pricing-table-price-currency h4">$</span><span class="pricing-table-price-amount h2"><?php echo $PRICE -> getPrice()?></span>/mo</div>
                                        </div>
                                        <ul class="pricing-table-features list-reset text-xs mt-24 mb-56">
                                            <?php
                                            $items = $PRICE -> getOffers();
                                    ...
                                    <div class="pricing-table-cta is-revealing">
                                        <a class="button button-primary button-shadow button-block" href="<?php $PRICE -> getLink()?>">Get early access</a>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach;?>
